...
\setlength{\parindent}{20pt}\indent Το σημερινό επαχθές σύστημα παιδείας στη
χώρα μας δεν προωθεί τη γνώση, αλλά την επιβάλλει! Τα διδακτικά βιβλία
προσφέρουν έτοιμες αλήθειες και νεκρώνουν το γόνιμο στοχασμό.
\end{document}