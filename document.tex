...
\newline\setlength{\parindent}{20pt}\indent Ο όρος χουλιγκανισμός
(hooliganism), άρχισε να χρησιμοποιείται απο τη δεκαετία του 1890, για να χαρακτηρίσει τη συμπεριφορά συμμοριών των δρόμων, στο Λονδίνο
...
Αμερική, με τον όρο  να γίνεται διαχρονικός, εκφράζοντας και στις μέρες μας τον ``τρόπο ζωής`` κάποιων ανεγκέφαλων κλειστών, αλλά πολυπληθών ομάδων ανθρώπων οι
...
\subsection*{Μορφές και αίτια του μαθητικού
χουλιγκανισμού}
Οι εκπαιδευτικές κοιν΄΄οτητε
